defmodule ExFleetYardsApi.Routes.Game.StationController do
  use ExFleetYardsApi, :controller
  use ExFleetYardsApi.ControllerGenerators

  tags ["game"]

  plug :put_view, ExFleetYardsApi.Routes.Game.StationJson
  ...
  operation :shop,
    ...
    responses: [
      ok: {"Shop", "application/json", ExFleetYardsApi.Schemas.Single.Shop},
  ...
  operation :commodities,
    ...
    responses: [
      ok:
        {"ShopCommodityList", "application/json", ExFleetYardsApi.Schemas.List.ShopCommodityList},
      not_found: {"Error", "application/json", ExFleetYardsApi.Schemas.Single.Error},
      internal_server_error: {"Error", "application/json", ExFleetYardsApi.Schemas.Single.Error}
    ]
