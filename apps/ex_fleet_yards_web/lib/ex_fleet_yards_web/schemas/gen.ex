defmodule ExFleetYardsWeb.Schemas.Gen do
  defmacro gen_pagination(inner, opts \\ []) do
    ...
    properties =
      %{
        ...
        metadata: ExFleetYardsWeb.Schemas.Single.PaginationMetadata
      }
    ...
    module = Module.concat([ExFleetYardsWeb, Schemas, List, module_name])
  ...
  #          metadata: ExFleetYardsWeb.Schemas.PaginationMetadata
  #        },
  #        required: [:data, :metadata],
