defmodule ExFleetYardsWeb.Schemas.Single do
    ...
    OpenApiSpex.schema(%{
      ...
      properties: %{
        ...
        celestialObjects: %Schema{
          type: :array,
          items: ExFleetYardsWeb.Schemas.Single.CelestialObject
        },
  ...
  defmodule CelestialObject do
    ...
    OpenApiSpex.schema(%{
      ...
      properties: %{
        ...
        starsystem: ExFleetYardsWeb.Schemas.Single.StarSystem
      },
  ...
  defmodule Model do
    ...
    OpenApiSpex.schema(%{
      ...
      type: :object,
      properties: %{
        manufacturer: ExFleetYardsWeb.Schemas.Single.Manufacturer,
        createdAt: %Schema{type: :string, format: :"date-time"},
        updatedAt: %Schema{type: :string, format: :"date-time"}
      }
    })
  ...
  defmodule Station do
    ...
    OpenApiSpex.schema(%{
      ...
      properties: %{
        ...
        shops: %Schema{type: :array, items: ExFleetYardsWeb.Schemas.Single.Shop},
        celestialObject: ExFleetYardsWeb.Schemas.Single.CelestialObject,
  ...
  defmodule RoadmapItem do
    ...
    OpenApiSpex.schema(%{
      ...
      properties: %{
        ...
        model: ExFleetYardsWeb.Schemas.Single.Model,
        createdAt: %Schema{type: :string, format: :"date-time"},
        updatedAt: %Schema{type: :string, format: :"date-time"}
      },
      required: [:id, :name]
